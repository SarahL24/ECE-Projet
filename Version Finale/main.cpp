...
int main()
{
    ...
    while ( !key[KEY_ESC] && quit == false)
    {
        ...
        g.cherche_forte_connexe(); /*!Cherche les composantes fortement connexe d'un graphe*/

        g.affiche_graphe_reduit(); /*!Affiche le graphe reduiten effacant le precedant*/
        ...
        //etude temporelle
        tours_de_boucle=g.simu(tours_de_boucle); /*!Etude temporelle 1*/
        tours_de_boucle = g.simu2(tours_de_boucle); /*!Etude temporelle 2*/
