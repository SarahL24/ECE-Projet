...
void Graph::make_example()
{
    ...
    add_interfaced_vertex(0, 30.0, 200, 100, "Allausaure.bmp");
    add_interfaced_vertex(1, 60.0, 400, 100, "Foret.bmp");
    ...
    add_interfaced_vertex(6,  0.0, 300, 500, "Ver de terre .bmp");
...
{
    //std::map<int, Arc>::iterator it_arc;
    //std::map<int, Sommet>::iterator it_som;
...
void Graph::charge_file(bool charge)
{
        ...
        if(charge == true)
        {
            ...
            std::string path;
            std::cout<<"entrer le chemin pour charger votre graphe : ";
            std::cin>>path;
